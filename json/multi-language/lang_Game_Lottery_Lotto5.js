var arrLang = {
    ...
    'TC': {
      ...
      //
      'Lottery':'彩票',
      'gameDetail_p1': '時時彩是紅透全國彩票遊戲。遊戲不僅富有趣味性，投注方式更是五花八門，既刺激又好玩。玩家只需要押中開獎彩球號碼排列組合，豐厚獎金隨即奉上。',
      'feature_1.1': '投注選項',
      'feature_1.2': '豐富多變',
      'feature_1_p': '「時時彩」備有多種投注組合，且每款組合派彩回報也各有不同，賠率千變萬化，玩家隨時搏取更豐厚獎金。',
      'feature_2.1': '自定籌碼金額',
      'feature_2.2': '',
      'feature_2_p': '除了預設籌碼外，玩家可跳轉至「娛樂」模式，設定不同籌碼金額，贏取更豐盛獎金。',
      'feature_3.1': '數據 掌握',
      'feature_3.2': '遊戲走勢',
      'feature_3_p': '我們提供一系列數據提示，包括全方位路紙和開獎結果；透過數據走勢分析開獎結果，以圖表方式顯示，一目了然，為玩家節省下注前準備時間。',
    },
    ...
    'SC': {
      ...
      'PrivacyPolicy' : '隐私政策',
      'HelloThere' : '哈囉！',
      'thankyou_p' : '你你现在已在我们联络名单中，我们会将最新消息、产品和影片等资讯通过电邮发送给你。',
      'Okay' : '关闭',
      //input placeholder
      ...
      //
      'Lottery':'彩票',
      'gameDetail_p1': '时时彩是红透全国彩票游戏。游戏不仅富有趣味性，投注方式更是五花八门，既刺激又好玩。玩家只需要押中开奖彩球号码排列组合，丰厚奖金随即奉上。',
      'feature_1.1': '投注选项',
      'feature_1.2': '丰富多变',
      'feature_1_p': '「时时彩」备有多种投注组合，且每款组合派彩回报也各有不同，赔率千变万化，玩家随时搏取更丰厚奖金。',
      'feature_2.1': '自定筹码金额',
      'feature_2.2': '',
      'feature_2_p': '除了预设筹码外，玩家可跳转至「娱乐」模式，设定不同筹码金额，赢取更丰盛奖金。',
      'feature_3.1': '数据 掌握',
      'feature_3.2': '遊戲走勢',
      'feature_3_p': '我们提供一系列数据提示，包括全方位路单和开奖结果；透过数据走向分析开奖结果，以图表方式显示，一目了然，为玩家节省下注前准备时间。',
    }
  };
...
var arrImg = {
  'EN': [{
      ...
      'feature3': 'images/game/game_Lotto5/en/game_Lotto5_feature3_1x.png 500w, images/game/game_Lotto5/en/game_Lotto5_feature3_2x.png 1000w',
    }],
  'TC': [{
      //WE Logo
      ...
      'feature3': 'images/game/game_Lotto5/tc/game_Lotto5_feature3_1x.png 500w, images/game/game_Lotto5/tc/game_Lotto5_feature3_2x.png 1000w',  
    }],
  'SC': [{
      //WE Logo
      ...
      'feature3': 'images/game/game_Lotto5/sc/game_Lotto5_feature3_1x.png 500w, images/game/game_Lotto5/sc/game_Lotto5_feature3_2x.png 1000w',  
    }]
};