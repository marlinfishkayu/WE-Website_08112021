var arrLang = {
    'EN': {
      ...
      'gameDetail_p1': 'Our state-of-the-art technology allows players to squeeze cards "on-site". They can squeeze cards in their preference. WE will bring more fun to games which excites our players like being on spot. ',
    ...
    'TC': {
      ...
      'feature_1.1': '3D 揭牌展示',
      'feature_1.2': '仿如置身現場',
      'feature_1_p': '我們在咪牌百家樂中加入3D互動設計，玩家只要下注「庄」、「閒」，即可參與咪牌，恍如置身現場，體驗開牌緊張刺激。',
      'feature_2': '詳盡統計數據',
      'feature_2_p': '遊戲大堂展示百家樂本靴及過往100局各投注區勝出比例，各檯趨勢一目了然。玩家如果遇上心水局數，更可用「快速投注」功能在大堂直接下注。',
      'feature_3': '咪牌教學',
      'feature_3_p': '首次參與咪牌百家樂玩家，系統會自動展示「咪牌教學」，以3D模式簡單介紹互動咪牌方法，讓玩家掌握咪牌竅門。',
    },
    ...
    'SC': {
      ...
      'feature_1.1': '3D 揭牌展示',
      'feature_1.2': '仿如置身现场',
      'feature_1_p': '我们在咪牌百家乐中加入3D互动设计，玩家只要下注「庄」、「闲」，即可参与咪牌，恍如置身现场，体验开牌紧张刺激。',
      'feature_2': '详细数据统计',
      'feature_2_p': '游戏大堂展示百家乐本靴及过往100局各投注区的胜出比例，各游戏台趋势一目了然。玩家如果遇上合意局数，更可用「快速投注」功能在大堂直接下注。',
      'feature_3': '咪牌教学',
      'feature_3_p': '首次参与咪牌百家乐玩家，系统会自动展示「咪牌教学」，以3D模式简单介绍咪牌方法，让玩家掌握咪牌窍门。',
    }
  };
